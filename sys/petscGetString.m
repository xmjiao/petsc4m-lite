...
%petscGetString Obtain a character string in PETSC
%
%    str = petscGetString(name)
%
...
%     KSPPGMRES, KSPTCQMR, KSPBCGS, KSPIBCGS, KSPFBCGS, KSPQMRCGS,
...
elseif isequal(name, 'KSPQMRCGS')
    [str, toplevel] = get_string('KSPType', 'KSPQMRCGS', nargout > 1);
