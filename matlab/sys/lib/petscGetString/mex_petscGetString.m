function mex_petscGetString
% Build script for petscGetString

target = ['../../petscGetString.' mexext];

if ~exist('isnewer', 'file') || ...
        ~isnewer(target, 'mex_petscGetString.m', 'petscGetString_mex.c')
    ...
    build_cmd = ['mex CC=' CC ' -I../../../include ' INC, ...
        ...
        ' petscGetString.c petscGetString_mex.c -output ' target ...
